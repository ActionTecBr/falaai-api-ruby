  ...
  class Participant < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FalaAI::Participant` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FalaAI::Participant`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @interlocutor.nil?
        invalid_properties.push('invalid value for "interlocutor", interlocutor cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @interlocutor.nil?
      return false if @role.nil?
      role_validator = EnumAttributeValidator.new('String', ["agent", "client", "bot"])
      return false unless role_validator.valid?(@role)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] interlocutor Value to be assigned
    def interlocutor=(interlocutor)
      if interlocutor.nil?
        fail ArgumentError, 'interlocutor cannot be nil'
      end
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["agent", "client", "bot"])
