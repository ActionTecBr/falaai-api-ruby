  ...
  class VersionResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FalaAI::VersionResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FalaAI::VersionResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deploy_date')
        self.deploy_date = attributes[:'deploy_date']
      else
        self.deploy_date = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @deploy_date.nil?
        invalid_properties.push('invalid value for "deploy_date", deploy_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @deploy_date.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] deploy_date Value to be assigned
    def deploy_date=(deploy_date)
      if deploy_date.nil?
        fail ArgumentError, 'deploy_date cannot be nil'
      end
    ...
    def hash
      [service, version, deploy_date].hash
    end
