...
module FalaAI
  class EmailEvent
    ...
    def self.all_vars
      @all_vars ||= [SUBSCRIPTION_CREATED, AVULSO_COMPLETED, SUBSCRIPTION_UPGRADED, SUBSCRIPTION_DOWNGRADED, SUBSCRIPTION_CANCELED, CREDITS_LOW, CREDITS_EXHAUSTED, SUBSCRIPTION_RENEWED, PAYMENT_FAILED].freeze
    end
    ...
    def build_from_hash(value)
      return value if EmailEvent.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #EmailEvent"
    end
  end
end
