...
# Unit tests for FalaAI::UsageApi
...
describe 'UsageApi' do
  ...
  describe 'test an instance of UsageApi' do
    it 'should create an instance of UsageApi' do
      expect(@api_instance).to be_instance_of(FalaAI::UsageApi)
    end
  end

  # unit tests for get_usage_by_key_v1_usage_by_key_get
  # Get Usage By Key
  # @param [Hash] opts the optional parameters
  # @option opts [String] :key_id 
  # @return [Array<UsageByKeyItem>]
  describe 'get_usage_by_key_v1_usage_by_key_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_usage_log_v1_usage_log_get
  # Get Usage Log
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_usage_log_v1_usage_log_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
