...
# Unit tests for FalaAI::HealthApi
...
describe 'HealthApi' do
  ...
  describe 'test an instance of HealthApi' do
    it 'should create an instance of HealthApi' do
      expect(@api_instance).to be_instance_of(FalaAI::HealthApi)
    end
  end
  ...
  # unit tests for health_check_head
  # Health Check
  # @param [Hash] opts the optional parameters
  # @return [HealthResponse]
  describe 'health_check_head test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
