...
# Unit tests for FalaAI::EmailAlertMessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::EmailAlertMessageResponse do
  #let(:instance) { FalaAI::EmailAlertMessageResponse.new }

  describe 'test an instance of EmailAlertMessageResponse' do
    it 'should create an instance of EmailAlertMessageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::EmailAlertMessageResponse)
    end
  end
