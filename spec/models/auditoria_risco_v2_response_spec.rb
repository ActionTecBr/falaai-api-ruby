...
# Unit tests for FalaAI::AuditoriaRiscoV2Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoV2Response do
  #let(:instance) { FalaAI::AuditoriaRiscoV2Response.new }

  describe 'test an instance of AuditoriaRiscoV2Response' do
    it 'should create an instance of AuditoriaRiscoV2Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoV2Response)
    end
  end
