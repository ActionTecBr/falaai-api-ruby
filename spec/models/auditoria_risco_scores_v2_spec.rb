...
# Unit tests for FalaAI::AuditoriaRiscoScoresV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoScoresV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoScoresV2.new }

  describe 'test an instance of AuditoriaRiscoScoresV2' do
    it 'should create an instance of AuditoriaRiscoScoresV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoScoresV2)
    end
  end
  ...
  describe 'test attribute "per_participant"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
