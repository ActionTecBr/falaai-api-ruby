...
# Unit tests for FalaAI::ParticipantDiagnostic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::ParticipantDiagnostic do
  #let(:instance) { FalaAI::ParticipantDiagnostic.new }

  describe 'test an instance of ParticipantDiagnostic' do
    it 'should create an instance of ParticipantDiagnostic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::ParticipantDiagnostic)
    end
  end
