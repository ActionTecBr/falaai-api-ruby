...
# Unit tests for FalaAI::WebhookListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::WebhookListResponse do
  #let(:instance) { FalaAI::WebhookListResponse.new }

  describe 'test an instance of WebhookListResponse' do
    it 'should create an instance of WebhookListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::WebhookListResponse)
    end
  end
