...
# Unit tests for FalaAI::UsageLogResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::UsageLogResponse do
  #let(:instance) { FalaAI::UsageLogResponse.new }

  describe 'test an instance of UsageLogResponse' do
    it 'should create an instance of UsageLogResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::UsageLogResponse)
    end
  end
