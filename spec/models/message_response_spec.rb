...
# Unit tests for FalaAI::MessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::MessageResponse do
  #let(:instance) { FalaAI::MessageResponse.new }

  describe 'test an instance of MessageResponse' do
    it 'should create an instance of MessageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::MessageResponse)
    end
  end
