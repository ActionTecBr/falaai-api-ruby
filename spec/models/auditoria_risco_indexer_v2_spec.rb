...
# Unit tests for FalaAI::AuditoriaRiscoIndexerV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoIndexerV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoIndexerV2.new }

  describe 'test an instance of AuditoriaRiscoIndexerV2' do
    it 'should create an instance of AuditoriaRiscoIndexerV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoIndexerV2)
    end
  end

  describe 'test attribute "suggested_terms_for_bank"' do
    it 'should work' do
