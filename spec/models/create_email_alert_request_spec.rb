...
# Unit tests for FalaAI::CreateEmailAlertRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::CreateEmailAlertRequest do
  #let(:instance) { FalaAI::CreateEmailAlertRequest.new }

  describe 'test an instance of CreateEmailAlertRequest' do
    it 'should create an instance of CreateEmailAlertRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::CreateEmailAlertRequest)
    end
  end
