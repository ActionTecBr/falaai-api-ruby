...
# Unit tests for FalaAI::AuditoriaRiscoAppliedActionV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoAppliedActionV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoAppliedActionV2.new }

  describe 'test an instance of AuditoriaRiscoAppliedActionV2' do
    it 'should create an instance of AuditoriaRiscoAppliedActionV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoAppliedActionV2)
    end
  end
