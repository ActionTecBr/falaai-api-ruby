...
# Unit tests for FalaAI::UsageByKeyItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::UsageByKeyItem do
  #let(:instance) { FalaAI::UsageByKeyItem.new }

  describe 'test an instance of UsageByKeyItem' do
    it 'should create an instance of UsageByKeyItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::UsageByKeyItem)
    end
  end
  ...
  describe 'test attribute "request_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
