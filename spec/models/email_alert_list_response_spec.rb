...
# Unit tests for FalaAI::EmailAlertListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::EmailAlertListResponse do
  #let(:instance) { FalaAI::EmailAlertListResponse.new }

  describe 'test an instance of EmailAlertListResponse' do
    it 'should create an instance of EmailAlertListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::EmailAlertListResponse)
    end
  end
