...
# Unit tests for FalaAI::HTTPValidationError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::HTTPValidationError do
  #let(:instance) { FalaAI::HTTPValidationError.new }

  describe 'test an instance of HTTPValidationError' do
    it 'should create an instance of HTTPValidationError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::HTTPValidationError)
    end
  end
