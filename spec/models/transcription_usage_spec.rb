...
# Unit tests for FalaAI::TranscriptionUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::TranscriptionUsage do
  #let(:instance) { FalaAI::TranscriptionUsage.new }

  describe 'test an instance of TranscriptionUsage' do
    it 'should create an instance of TranscriptionUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::TranscriptionUsage)
    end
  end

  describe 'test attribute "audio_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "credits_consumed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
