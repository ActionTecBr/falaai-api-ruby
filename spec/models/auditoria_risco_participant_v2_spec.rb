...
# Unit tests for FalaAI::AuditoriaRiscoParticipantV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoParticipantV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoParticipantV2.new }

  describe 'test an instance of AuditoriaRiscoParticipantV2' do
    it 'should create an instance of AuditoriaRiscoParticipantV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoParticipantV2)
    end
  end
