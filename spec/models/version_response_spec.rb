...
# Unit tests for FalaAI::VersionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::VersionResponse do
  #let(:instance) { FalaAI::VersionResponse.new }

  describe 'test an instance of VersionResponse' do
    it 'should create an instance of VersionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::VersionResponse)
    end
  end
  ...
  describe 'test attribute "deploy_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
