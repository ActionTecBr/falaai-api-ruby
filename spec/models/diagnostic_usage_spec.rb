...
# Unit tests for FalaAI::DiagnosticUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::DiagnosticUsage do
  #let(:instance) { FalaAI::DiagnosticUsage.new }

  describe 'test an instance of DiagnosticUsage' do
    it 'should create an instance of DiagnosticUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::DiagnosticUsage)
    end
  end
