...
# Unit tests for FalaAI::DiagnosticTextAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::DiagnosticTextAnalysis do
  #let(:instance) { FalaAI::DiagnosticTextAnalysis.new }

  describe 'test an instance of DiagnosticTextAnalysis' do
    it 'should create an instance of DiagnosticTextAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::DiagnosticTextAnalysis)
    end
  end
