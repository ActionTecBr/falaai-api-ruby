...
# Unit tests for FalaAI::AuditoriaRiscoAnalysisV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoAnalysisV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoAnalysisV2.new }

  describe 'test an instance of AuditoriaRiscoAnalysisV2' do
    it 'should create an instance of AuditoriaRiscoAnalysisV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoAnalysisV2)
    end
  end

  describe 'test attribute "global_metrics"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "final_analysis"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
