...
# Unit tests for FalaAI::AuditoriaRiscoTimelineV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoTimelineV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoTimelineV2.new }

  describe 'test an instance of AuditoriaRiscoTimelineV2' do
    it 'should create an instance of AuditoriaRiscoTimelineV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoTimelineV2)
    end
  end

  describe 'test attribute "turns_sentiment"' do
    it 'should work' do
  ...
  describe 'test attribute "audio_groups_found"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
