...
# Unit tests for FalaAI::EmailAlertItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::EmailAlertItem do
  #let(:instance) { FalaAI::EmailAlertItem.new }

  describe 'test an instance of EmailAlertItem' do
    it 'should create an instance of EmailAlertItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::EmailAlertItem)
    end
  end
