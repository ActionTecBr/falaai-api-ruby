...
# Unit tests for FalaAI::HealthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::HealthResponse do
  #let(:instance) { FalaAI::HealthResponse.new }

  describe 'test an instance of HealthResponse' do
    it 'should create an instance of HealthResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::HealthResponse)
    end
  end
