...
# Unit tests for FalaAI::DiagnosticRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::DiagnosticRequest do
  #let(:instance) { FalaAI::DiagnosticRequest.new }

  describe 'test an instance of DiagnosticRequest' do
    it 'should create an instance of DiagnosticRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::DiagnosticRequest)
    end
  end
