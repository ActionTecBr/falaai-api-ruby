...
# Unit tests for FalaAI::AudioInputMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AudioInputMeta do
  #let(:instance) { FalaAI::AudioInputMeta.new }

  describe 'test an instance of AudioInputMeta' do
    it 'should create an instance of AudioInputMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AudioInputMeta)
    end
  end
  ...
  describe 'test attribute "original_format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
