...
# Unit tests for FalaAI::UpdateEmailAlertRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::UpdateEmailAlertRequest do
  #let(:instance) { FalaAI::UpdateEmailAlertRequest.new }

  describe 'test an instance of UpdateEmailAlertRequest' do
    it 'should create an instance of UpdateEmailAlertRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::UpdateEmailAlertRequest)
    end
  end
