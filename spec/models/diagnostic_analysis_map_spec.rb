...
# Unit tests for FalaAI::DiagnosticAnalysisMap
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::DiagnosticAnalysisMap do
  #let(:instance) { FalaAI::DiagnosticAnalysisMap.new }

  describe 'test an instance of DiagnosticAnalysisMap' do
    it 'should create an instance of DiagnosticAnalysisMap' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::DiagnosticAnalysisMap)
    end
  end

  describe 'test attribute "dialogue_summary"' do
    it 'should work' do
  ...
  describe 'test attribute "identified_action"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "identified_label"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "participants_identified"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
