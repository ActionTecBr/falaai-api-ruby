...
# Unit tests for FalaAI::Participant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::Participant do
  #let(:instance) { FalaAI::Participant.new }

  describe 'test an instance of Participant' do
    it 'should create an instance of Participant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::Participant)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["agent", "client", "bot"])
