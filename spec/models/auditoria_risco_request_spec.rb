...
# Unit tests for FalaAI::AuditoriaRiscoRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoRequest do
  #let(:instance) { FalaAI::AuditoriaRiscoRequest.new }

  describe 'test an instance of AuditoriaRiscoRequest' do
    it 'should create an instance of AuditoriaRiscoRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoRequest)
    end
  end
  ...
  describe 'test attribute "audio_events"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "call_direction"' do
    it 'should work' do
      ...
      #   expect { instance.call_direction = value }.not_to raise_error
      # end
    end
  end
