...
# Unit tests for FalaAI::AuditoriaRiscoMetaV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoMetaV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoMetaV2.new }

  describe 'test an instance of AuditoriaRiscoMetaV2' do
    it 'should create an instance of AuditoriaRiscoMetaV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoMetaV2)
    end
  end
  ...
  describe 'test attribute "call_duration_s"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "analyzed_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
