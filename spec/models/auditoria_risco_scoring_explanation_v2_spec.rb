...
# Unit tests for FalaAI::AuditoriaRiscoScoringExplanationV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoScoringExplanationV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoScoringExplanationV2.new }

  describe 'test an instance of AuditoriaRiscoScoringExplanationV2' do
    it 'should create an instance of AuditoriaRiscoScoringExplanationV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoScoringExplanationV2)
    end
  end
