...
# Unit tests for FalaAI::UpdateWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::UpdateWebhookRequest do
  #let(:instance) { FalaAI::UpdateWebhookRequest.new }

  describe 'test an instance of UpdateWebhookRequest' do
    it 'should create an instance of UpdateWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::UpdateWebhookRequest)
    end
  end
