...
# Unit tests for FalaAI::DiagnosticCategoricalAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::DiagnosticCategoricalAnalysis do
  #let(:instance) { FalaAI::DiagnosticCategoricalAnalysis.new }

  describe 'test an instance of DiagnosticCategoricalAnalysis' do
    it 'should create an instance of DiagnosticCategoricalAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::DiagnosticCategoricalAnalysis)
    end
  end

  describe 'test attribute "list_choice"' do
    it 'should work' do
  ...
  describe 'test attribute "evidence_phrases"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
