...
# Unit tests for FalaAI::AudioEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AudioEvent do
  #let(:instance) { FalaAI::AudioEvent.new }

  describe 'test an instance of AudioEvent' do
    it 'should create an instance of AudioEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AudioEvent)
    end
  end
