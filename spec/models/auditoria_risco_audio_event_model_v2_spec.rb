...
# Unit tests for FalaAI::AuditoriaRiscoAudioEventModelV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoAudioEventModelV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoAudioEventModelV2.new }

  describe 'test an instance of AuditoriaRiscoAudioEventModelV2' do
    it 'should create an instance of AuditoriaRiscoAudioEventModelV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoAudioEventModelV2)
    end
  end
  ...
  describe 'test attribute "windows_s"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
