...
# Unit tests for FalaAI::AuditoriaRiscoUsageV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::AuditoriaRiscoUsageV2 do
  #let(:instance) { FalaAI::AuditoriaRiscoUsageV2.new }

  describe 'test an instance of AuditoriaRiscoUsageV2' do
    it 'should create an instance of AuditoriaRiscoUsageV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::AuditoriaRiscoUsageV2)
    end
  end
