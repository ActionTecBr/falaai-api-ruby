...
# Unit tests for FalaAI::TranscriptionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FalaAI::TranscriptionResponse do
  #let(:instance) { FalaAI::TranscriptionResponse.new }

  describe 'test an instance of TranscriptionResponse' do
    it 'should create an instance of TranscriptionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FalaAI::TranscriptionResponse)
    end
  end
  ...
  describe 'test attribute "language_confidence"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
